            ...
            <div class="row align-items-center">
                <div class="col-lg-4">
                    <div class="thumbnail-left">
                        <img src="{{asset('/')}}website/assets/images/about/02.jpg" alt="">
                    </div>
                </div>
        ...
        <div class="container-3">
            ...
            <div class="row g-5 mt--40">
                <div class="col-lg-3 col-md-6 col-sm-12 col-12">
                    ...
                    <div class="single-team-style-one">
                        <a href="#" class="thumbnail">
                            <img src="{{asset('/')}}website/assets/images/team/01.jpg" alt="team_single">
                        </a>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 col-12">
                    ...
                    <div class="single-team-style-one">
                        <a href="#" class="thumbnail">
                            <img src="{{asset('/')}}website/assets/images/team/02.jpg" alt="team_single">
                        </a>
                        <div class="bottom-content-area">
                            <div class="top">
                                <h3 class="title">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 col-12">
                    ...
                    <div class="single-team-style-one">
                        <a href="#" class="thumbnail">
                            <img src="{{asset('/')}}website/assets/images/team/03.jpg" alt="team_single">
                        </a>
                        <div class="bottom-content-area">
                            <div class="top">
                                <h3 class="title">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 col-12">
                    ...
                    <div class="single-team-style-one">
                        <a href="#" class="thumbnail">
                            <img src="{{asset('/')}}website/assets/images/team/04.jpg" alt="team_single">
                        </a>
                        <div class="bottom-content-area">
                            <div class="top">
                                <h3 class="title">
                                                ...
                                                <div class="swiper-slide">
                                                    ...
                                                    <div class="single-customers-feedback-area">
                                                        <div class="top-thumbnail-area">
                                                            <div class="left">
                                                                <img src="{{asset('/')}}website/assets/images/testimonial/01.png" alt="logo">
                                                            ...
                                                            <div class="right">
                                                                <img src="{{asset('/')}}website/assets/images/testimonial/02.png" alt="logo">
                                                            </div>
                                                        </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="social-and-payment-area-wrapper">
                        ...
                        <div class="payment-access">
                            ...
                            <img src="{{asset('/')}}website/assets/images/payment/01.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
