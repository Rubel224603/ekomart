                                    ...
                                    <div class="details-product-area">
                                        <div class="product-thumb-area">
                                            ...
                                            <div class="thumb-wrapper on filterd-items figure">
                                                ...
                                                <div class="product-thumb zoom" onmousemove="zoom(event)" style="background-image: url({{asset('backend/upload/images/product/'.$product->image)}}">
                                                    <img src="{{asset('backend/upload/images/product/'.$product->image)}}" alt="product-thumb">
                                                </div>
                                            ...
                                            @foreach($otherImages as $imgKey=>$otherImage)
                                                ...
                                                <div class="thumb-wrapper two{{$imgKey}} filterd-items hide">
                                                    <div class="product-thumb zoom" onmousemove="zoom(event)" style="background-image: url({{asset('/backend/upload/images/other-image/'.$otherImage->other_image)}})"><img src="{{asset('/backend/upload/images/other-image/'.$otherImage->other_image)}}" alt="product-thumb">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="product-thumb-filter-group">
                                                @foreach($otherImages as $key=>$otherImage)
                                                    <div class="thumb-filter filter-btn {{$key== 0 ? 'active':''}}" data-show=".two{{$key}}"><img src="{{asset('/backend/upload/images/other-image/'.$otherImage->other_image)}}" alt="product-thumb-filter"></div>
                                                @endforeach
                                            </div>
                                        </div>
                                        <div class="contents">
                                            ...
                                            <span class="product-price mb--15 d-block" style="color: #DC2626; font-weight: 600;">${{$product->selling_price}}<span class="old-price ml--15">${{$product->product_price}}</span></span>
                                        ...
                                        <div class="single-shopping-card-one">
                                            ...
                                            <div class="image-and-action-area-wrapper">
                                                <a href="#" class="thumbnail-preview">
                                                    ...
                                                    <img src="{{asset('backend/upload/images/product/'.$product->image)}}" alt="grocery" style="height: 250px !important;">
                                                </a>
