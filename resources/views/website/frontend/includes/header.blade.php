                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="logo-search-category-wrapper style-five-call-us">
                                        <a href="{{route('/')}}" class="logo-area">
                                            <img src="{{asset('/')}}website/assets/images/logo/logo-01.svg" alt="logo-main" class="logo">
                                        </a>
                                        ...
                                        <div class="accont-wishlist-cart-area-header">
                                            <a href="{{route('account')}}" class="btn-border-only account">
                                            ...
                                            <div class="btn-border-only cart category-hover-header">
                                                ...
                                                <div class="category-sub-menu card-number-show">
                                                    ...
                                                    <div class="cart-item-1 border-top">
                                                        <div class="img-name">
                                                            <div class="thumbanil">
                                                                <img src="{{asset('/')}}website/assets/images/shop/cart-1.png" alt="">
                                                            </div>
                                                            <div class="details">
                                                    ...
                                                    <div class="cart-item-1">
                                                        <div class="img-name">
                                                            <div class="thumbanil">
                                                                <img src="{{asset('/')}}website/assets/images/shop/05.png" alt="">
                                                            </div>
                                                            <div class="details">
                                                                <a href="shop-details.html">
                                                                    <h5 class="title">Foster Farms Breast Nuggets Shaped Chicken</h5>
                                                    ...
                                                    <div class="cart-item-1">
                                                        <div class="img-name">
                                                            <div class="thumbanil">
                                                                <img src="{{asset('/')}}website/assets/images/shop/04.png" alt="">
                                                            </div>
                                                            <div class="details">
                                                                <a href="shop-details.html">
                                                                    <h5 class="title">Foster Farms Breast Nuggets Shaped Chicken</h5>
                                                    ...
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <a href="shop-grid-sidebar.html" class="feature-add-megamenu-area">
                                                                <img src="{{asset('/')}}website/assets/images/feature/05.jpg" alt="feature_product">
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
                    ...
                    <div class="logo-search-category-wrapper after-md-device-header header-mid-five-call">
                        ...
                        <div class="category-search-wrapper">
                            <div class="category-btn category-hover-header">
                                <img class="parent" src="{{asset('/')}}website/assets/images/icons/bar-1.svg" alt="icons">
