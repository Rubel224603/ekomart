    ...
    var rtsJs = {
        ...
        modalpopupCard: function(){
            // Newsletter popup
              $(document).ready(function () {
                function showpanel() {
                  $(".anywere-dashboard").addClass("bgshow");
                  $(".rts-newsletter-popup").addClass("popup");
                }
                setTimeout(showpanel, 4000)
              });

              $(".anywere-dashboard").on('click', function () {
                $(".rts-newsletter-popup").removeClass("popup")
                $(".anywere-dashboard").removeClass("bgshow")
              });
              ...
              $(".product-details-popup-btn").on('click', function () {
                ...
                $("#anywhere-dashboard").addClass("bgshow");
              });
              ...
              $(".product-details-close-btn").on('click', function () {
                ...
                $("#anywhere-dashboard").removeClass("bgshow");
              });
              ...
              $("#anywhere-dashboard").on('click', function () {
        ...
        sideMenu:function(){
          ...
          $(document).on('click', '#anywhere-dashboard', function () {
            $("#side-bar").removeClass("show");
            $("#anywhere-dashboard").removeClass("bgshow");
          });
