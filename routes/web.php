...
Route::post('/sub-category/update/{id}',[SubCategoryController::class,'updateSubCategory'])->name('update.sub-category');
Route::get('/sub-category/delete/{id}',[SubCategoryController::class,'deleteSubCategory'])->name('delete.sub-category');
//Brand...
Route::get('/brand-add',[BrandController::class,'createBrand'])->name('brand.create');
Route::post('/brand-store',[BrandController::class,'storeBrand'])->name('brand.store');
Route::get('/brand-list',[BrandController::class,'listBrand'])->name('brand.list');
